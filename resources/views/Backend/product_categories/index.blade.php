...
@section('content_body')
    <div class="card">
        <div class="card-header text-right">
            <a href="{{ route('admin.productCategory.create') }}" class="btn btn-outline-secondary" wire:navigate><i
                    ...
                    <tbody>
                        @foreach ($productCategories as $productCategory)
                            <tr>
                                ...
                                <td class="align-middle text-left">
                                    <img src="{{ isset($productCategory->image) && file_exists(public_path('storage/galleries/' . $productCategory->image)) ? asset('storage/galleries/' . $productCategory->image) : asset('img/Imagen-no-disponible.png') }}"
                                ...
                                <td class="text-right align-middle">
                                    <a href="{{ route('admin.productCategory.index', $productCategory) }}" wire:navigate
