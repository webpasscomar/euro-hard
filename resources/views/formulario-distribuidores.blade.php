        ...
        <div class="col-lg-4">
          <div class="content-colum-form-izq">
            <div class="description-nove">
              Los invitamos a realizar la siguiente encuesta para continuar garantizando la satisfacción que brinda
              EUROHARD. Toda las respuestas que usted nos brinde serán confidenciales, de uso exclusivo del área de
              marketing.
            </div>
          </div>
        </div>
            ...
            <form class="row" id="sectionForm">
              ...
              <div class="check-content">
                <div class="check-individual">
                  <div class="row">
                    ...
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Otros" id="checkOtros" value="3" class="only-one myinput large">
                      Otros
                    </div>
                  </div>
                </div>
              ...
              <div class="check-content" id="sectionFormFamilia">
                <div class="check-individual">
                  <div class="row">
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Elementos de apoyo" id="1" value="Elementos de apoyo"
                        class="myinput large"> Elementos de apoyo
                    </div>
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Elementos de puerta" id="2" value="Elementos de puerta"
                        class="myinput large"> Elementos de puerta
                    </div>
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Elementos de cajón" id="3" value="Elementos de cajón"
                        class="myinput large"> Elementos de cajón
                    </div>
                  </div>
                  <div class="row filas-checkbox">
                    ...
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Elementos de unión" id="5" value="Elementos de unión"
                        class="myinput large"> Elementos de unión
                    </div>
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Barrales y tiradores" id="6" value="Barrales y tiradores"
                        class="myinput large"> Barrales y tiradores
                    </div>
                  </div>
                  <div class="row filas-checkbox">
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Accesorios de cocina" id="7" value="Accesorios de cocina"
                        class="myinput large"> Accesorios de cocina
                    </div>
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Acc. de placard" id="8" value="Acc. de placard"
                        class="myinput large"> Acc. de placard
                    </div>
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Acc. para muebles de ofic." id="9"
                        value="Acc. para muebles de ofic." class="myinput large"> Acc. para muebles de ofic.
                    </div>
                  </div>
                  <div class="row filas-checkbox">
                    <div class="col-lg-4 content-check-input">
                    ...
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Aluminio" id="11" value="Aluminio" class="myinput large">
                      Aluminio
                    </div>
                    <div class="col-lg-4 content-check-input">
                      <input type="checkbox" name="Herramientas" id="12" value="Herramientas"
                        class="myinput large"> Herramientas
                    </div>
                  </div>
                </div>
              </div>
