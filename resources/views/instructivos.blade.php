                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 p-3 content-product">
                                <div class="content-img-instructivo">
                                    <img src="{{ $product->image_main && file_exists(public_path('storage/products/' . $product->image_main)) ? asset('storage/products/' . $product->image_main) : asset('img/no_disponible.jpg') }}"
