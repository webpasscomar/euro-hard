  ...
  <div class="main-container">
    <div class="container-hero">
      ...
      <div class="img-hero">
        ...
        <img src="{{ asset('img/headers/empresa.jpg') }}" alt="Empresa" class="img-fluid">
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <p>Con más de 15 años construyendo calidad Argentina, EUROHARD se ha consolidado como una de las tres marcas
            líderes de herrajes y accesorios para el mueble en todo el país, siendo la más joven entre ellas y la de mayor
            proyección de crecimiento.</p>
          ...
          <ul>
            <li>
              <p>
                <b>Transformación Digital</b>, implementando SAP B1 y PRODUMEX (WMS) para optimizar nuestra gestión sobre
                una
                plataforma de primera línea a nivel mundial, con el objetivo de desarrollar nuevos y mejores servicios
                para
                nuestros clientes.
          ...
          <ul>
            <li>
              <p>
                ...
                incorporando
                equipamiento de última generación para la optimización de los procesos de recepción, almacenamiento y
                despacho de productos. Algunos de los principales logros que podemos destacar son el incremento de un 95%
                en
                la capacidad de almacenamiento, la reducción en un 50% del tiempo promedio de preparación de pedidos,
                entre
                otros.
              </p>
            </li>
