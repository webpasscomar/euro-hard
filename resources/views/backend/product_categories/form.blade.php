...
<div class="row">
  ...
  <div class="col-md-4">
    <div class="form-group mb-3">
      ...
      <input type="text" id="feature" feature="feature" class="form-control"
          ...
          @forelse ($colors as $color)
            <div class="form-check mb-2">
              <input class="form-check-input" type="radio" name="color" id="{{ 'color' . $color->id }}"
                value="{{ $color->color }}" style="border:1px solid grey;" onclick="previewColor(event)"
