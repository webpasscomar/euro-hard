...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="image_main" class="form-label">Imágen principal</label><span
                class="fs-4 text-danger">*</span>
...
<div class="row">
    ...
    <div class="row">
        <label class="mt-3 mb-4 fs-5">Galeria de imágenes <small class="fs-6 text-secondary">( Se deben cargar en el
                orden
