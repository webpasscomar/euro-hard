<div class="row">
  ...
  <div class="col-md-2">
    <div class="form-group mb-3">
      <label for="code" class="form-label">Código</label><span class="fs-4 text-danger">*</span>
  ...
  <div class="col-md-2">
    <div class="form-group mb-3 text-center mt-3">
      <label for="product_id" class="form-label">¿Es nuevo?</label>
...
<div class="row">
        ...
        <ul class="dropdown-menu w-100 p-2">
          @forelse ($colors as $color)
            <div class="form-check mb-2">
              <input class="form-check-input" type="checkbox" name="colors[]" id="{{ 'color' . $color->id }}"
                value="{{ $color->id }}" style="border:1px solid grey;" onclick="event.stopPropagation()"
              ...
              <div style="border:1px solid grey; background-color: {{ $color->color }}">
                <label class="form-check-label w-100" for="{{ 'color' . $color->id }}" style="opacity: 0;"
  ...
  <div class="col-md-4">
    <div class="form-group mb-4">
      <label for="productCategory_id" class="form-label">Ambiente & Cap&iacute;tulo</label><span
  ...
  <div class="col-md-2">
    <div class="form-group mb-3">
      <label for="orderNumber" class="form-label">Orden</label><span class="fs-4 text-danger">*</span>
      <input class="form-control" type="text" id="orderNumber" name="orderNumber"
        value="{{ old('orderNumber', $product->orderNumber ?? '') }}">
      @error('orderNumber')
        <span class="ms-1 text-danger">{{ $message }}</span>
      @enderror
    </div>
...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="form-group mb-3">
      ...
      <input type="file" id="image_main" name="image_main" class="form-control" accept=".jpg, .jpeg, .png, .svg"
        onchange="imageMainPreview(event)">
...
<div class="row">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group mb-3">
        ...
        <input type="file" id="image_1" name="image_1" class="form-control" accept=".jpg, .jpeg, .png, .svg"
          onchange="imageGalleryPreview(event,1)">
        <small class="text-secondary d-block"><sup>*</sup> Imágenes jpg , png ó svg de 512px x
          512px - máximo:1mb
        </small>
        @error('image_1')
    ...
    <div class="col-md-4">
      <div class="form-group mb-3">
        ...
        <input type="file" id="image_2" name="image_2" class="form-control" accept=".jpg, .jpeg, .png, .svg"
          onchange="imageGalleryPreview(event,2)">
        <small class="text-secondary d-block"><sup>*</sup> Imágenes jpg , png ó svg de 512px x
          512px - máximo:1mb
        </small>
        @error('image_2')
    ...
    <div class="col-md-4">
      <div class="form-group mb-3">
        ...
        <input type="file" id="image_3" name="image_3" class="form-control" accept=".jpg, .jpeg, .png, .svg"
          onchange="imageGalleryPreview(event,3)">
        <small class="text-secondary d-block"><sup>*</sup> Imágenes jpg , png ó svg de 512px x
          512px - máximo:1mb
        </small>
        @error('image_3')
  ...
  <div class="row mt-3">
    ...
    <div class="col-md-4">
      <div class="form-group mb-3">
        ...
        <input type="file" id="image_4" name="image_4" class="form-control" accept=".jpg, .jpeg, .png, .svg"
          onchange="imageGalleryPreview(event,4)">
        <small class="text-secondary d-block"><sup>*</sup> Imágenes jpg , png ó svg de 512px x
          512px - máximo:1mb
        </small>
        @error('image_4')
    ...
    <div class="col-md-4">
      <div class="form-group mb-3">
        ...
        <input type="file" id="image_5" name="image_5" class="form-control" accept=".jpg, .jpeg, .png, .svg"
          onchange="imageGalleryPreview(event,5)">
        <small class="text-secondary d-block"><sup>*</sup> Imágenes jpg , png ó svg de 512px x
          512px - máximo:1mb
        </small>
        @error('image_5')
    ...
    <div class="col-md-4">
      <div class="form-group mb-3">
        ...
        <input type="file" id="image_6" name="image_6" class="form-control" accept=".jpg, .jpeg, .png, .svg"
          onchange="imageGalleryPreview(event,6)">
        <small class="text-secondary d-block"><sup>*</sup> Imágenes jpg , png ó svg de 512px x
          512px - máximo:1mb
        </small>
        @error('image_6')
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group mb-3">
        <label for="datasheet_file" class="form-label">Instructivo en PDF</label>
    ...
    <div class="col-md-4">
      <div class="form-group mb-3">
        <label for="video" class="form-label">Instructivo en Video (URL)</label>
    ...
    <div id="imgMainPreview">
      @if ($edit)
        @isset($product->image_main)
          ...
          <img
            src="{{ file_exists(public_path('storage/products/' . $product->image_main)) ? asset('storage/products/' . $product->image_main) : asset('img/no_disponible.jpg') }}"
    ...
    <div id="img1Preview" class="mt-3 mt-sm-0">
      @if ($edit)
        @isset($product->image_1)
          ...
          <img
            src="{{ file_exists(public_path('storage/products/' . $product->image_1)) ? asset('storage/products/' . $product->image_1) : asset('img/no_disponible.jpg') }}"
            alt="{{ $product->name }}" class="img-thumbnail img_view_edit">
        @endisset
      @endif
    </div>
    ...
    <div id="img2Preview" class="mt-3 mt-sm-0">
      @if ($edit)
        @isset($product->image_2)
          ...
          <img
            src="{{ file_exists(public_path('storage/products/' . $product->image_2)) ? asset('storage/products/' . $product->image_2) : asset('img/no_disponible.jpg') }}"
            alt="{{ $product->name }}" class="img-thumbnail img_view_edit">
        @endisset
      @endif
    </div>
    ...
    <div id="img3Preview" class="mt-3 mt-sm-0">
      @if ($edit)
        @isset($product->image_3)
          ...
          <img
            src="{{ file_exists(public_path('storage/products/' . $product->image_3)) ? asset('storage/products/' . $product->image_3) : asset('img/no_disponible.jpg') }}"
            alt="{{ $product->name }}" class="img-thumbnail img_view_edit">
        @endisset
      @endif
    </div>
    ...
    <div id="img4Preview" class="mt-3 mt-sm-0">
      @if ($edit)
        @isset($product->image_4)
          ...
          <img
            src="{{ file_exists(public_path('storage/products/' . $product->image_4)) ? asset('storage/products/' . $product->image_4) : asset('img/no_disponible.jpg') }}"
            alt="{{ $product->name }}" class="img-thumbnail img_view_edit">
        @endisset
      @endif
    </div>
    ...
    <div id="img5Preview" class="mt-3 mt-sm-0">
      @if ($edit)
        @isset($product->image_5)
          ...
          <img
            src="{{ file_exists(public_path('storage/products/' . $product->image_5)) ? asset('storage/products/' . $product->image_5) : asset('img/no_disponible.jpg') }}"
            alt="{{ $product->name }}" class="img-thumbnail img_view_edit">
        @endisset
      @endif
    </div>
    ...
    <div id="img6Preview" class="mt-3 mt-sm-0">
      @if ($edit)
        @isset($product->image_6)
          ...
          <img
            src="{{ file_exists(public_path('storage/products/' . $product->image_6)) ? asset('storage/products/' . $product->image_6) : asset('img/no_disponible.jpg') }}"
            alt="{{ $product->name }}" class="img-thumbnail img_view_edit">
        @endisset
      @endif
=======
