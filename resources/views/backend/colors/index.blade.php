            ...
            @foreach ($colors as $color)
              <tr>
                ...
                <td class="align-middle text-left">
                  <div class="w-8 h-8 rounded-full border-1 border-black" style="background-color: {{ $color->color }}">
                  </div>
                </td>
                <td>
                  {{ $color->name }}
                ...
                <td class="text-right align-middle">
                  <a href="{{ route('admin.colors.destroy', $color) }}" class="btn btn-sm btn-outline-danger"
