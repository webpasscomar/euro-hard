...
@section('content_body')
  <div class="card">
    <div class="card-header text-right">
      <a href="{{ route('admin.users.create') }}" class="btn btn-outline-secondary"><i class="fas fa-file mr-2"></i>Nuevo</a>
    </div>
            ...
            @foreach ($users as $user)
              <tr>
                ...
                <td class="text-right align-middle">
                  ...
                  <a href="{{ route('admin.users.destroy', $user) }}" class="btn btn-sm btn-outline-danger"
